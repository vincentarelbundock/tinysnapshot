...
expect_false(isTRUE(tinysnapshot::expect_snapshot_plot(p2, "plot-base")))
...
expect_false(isTRUE(tinysnapshot::expect_snapshot_plot(p2, "plot-ggplot2_variable")))
...
expect_false(isTRUE(tinysnapshot::expect_snapshot_plot(p4, "plot-ggplot2_theme")))