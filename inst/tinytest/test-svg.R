...
flag <- tinysnapshot::expect_snapshot_plot(p2, "svg-base")
expect_false(flag)
...
flag <- tinysnapshot::expect_snapshot_plot(p2, "svg-ggplot2_variable")
expect_false(flag)

p3 <- ggplot(mtcars, aes(mpg, hp)) + geom_point()
expect_snapshot_plot(p3, "svg-ggplot2_theme")
